...
const player = loadImage('./images/laserCannon.png');
const muntz = loadImage('./images/muntz.png');
const wallDurOne = loadImage('./images/durabillityOne.png');
const wallDurTwo = loadImage('./images/durabillityTwo.png');
const wallDurThree = loadImage('./images/durabillityThree.png');

const invaderKilledImage = loadImage('./images/invaderkilled.png');
const russelClosed = loadImage('./images/russelClosed.png');
const russelOpen = loadImage('./images/russelOpen.png');
const dougClosed = loadImage('./images/dougClosed.png');
const dougOpen = loadImage('./images/dougOpen.png');
const carlClosed = loadImage('./images/carlClosed.png');
const carlOpen = loadImage('./images/carlOpen.png');

const enemyBullet1 = loadImage('./images/enemyBullet1.png');
const enemyBullet2 = loadImage('./images/enemyBullet2.png');

const invaderShot = new Audio('./audio/invaderKilled.wav');
const playerShot = new Audio('./audio/playerShot.wav');
const playerShoot = new Audio('./audio/playerShoot.wav');

const ufoHighpitch = new Audio('./audio/ufoHighpitch.wav')
const ufoLowpitch = new Audio('./audio/ufoLowpitch.wav')

const fastInvader1 = new Audio('./audio/fastInvader1.wav')
const fastInvader2 = new Audio('./audio/fastInvader2.wav')
const fastInvader3 = new Audio('./audio/fastInvader3.wav')
const fastInvader4 = new Audio('./audio/fastInvader4.wav')
